...
<body>
    ...
    <div class="container">
        <h1>Book Your Bus #111</h1>
        <div class="buses-container">
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('punk')">
                    <img src="../Images/punk.jpeg" alt="punk" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>CYBERPUNK</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('Xrated')">
                    <img src="../Images/xrated.jpeg" alt="Menace 004" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>X RATED</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('fortune')">
                    <img src="../Images/fortune.jpg" alt="fortune" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>FORTUNE</p>
            </div>
