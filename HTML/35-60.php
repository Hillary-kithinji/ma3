...
<body>
    ...
    <div class="container">
        <h1>Book Your Bus #35/60</h1>
        <div class="buses-container">
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('opposite')">
                    <img src="../Images/manunda.jpg" alt="kenya one" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>OPPOSITE</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('heaven')">
                    <img src="../Images/heaven.jpg" alt="kaka mbweha" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>HELL IN HEAVEN</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('nurse')">
                    <img src="../Images/nurse2.jpg" alt="muhudumu" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>NIHT NURSE</p>
            </div>
