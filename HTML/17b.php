...
<head>
    ...
    <style>
        ...
        .buses-container {
            display: grid;
            grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); /* Adjusted for larger images */
            gap: 20px;
            padding: 20px;
        }
        .bus-item {
...
<body>
    ...
    <div class="container">
        <h1>Book Your Bus #17B</h1>
        <div class="buses-container">
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('Merlin')">
                    <img src="../Images/merlin.jpg" alt="merlin" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>Merlin</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('Menace 004')">
                    <img src="../Images/nthoge.jpeg" alt="Menace 004" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>Menace 004 (Wrench)</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('Menace 003')">
                    <img src="../Images/wizard.jpg" alt="Menace 003" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>Menace 003 (Invisible)</p>
            </div>
        </div>
    </div>
