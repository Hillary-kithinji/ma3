...
<body>
    ...
    <div class="container">
        <h1>Book Your Bus #125</h1>
        <div class="buses-container">
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('Moneyfest')">
                    <img src="../Images/monyfest.jpg" alt="Moneyfest" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>MoneyFest</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('Matrix Route: Rongai')">
                    <img src="../Images/matrix.jpeg" alt="Matrix" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>Matrix</p>
            </div>
            <div class="bus-item">
                <a href="javascript:void(0)" onclick="showBookingForm('Batman')">
                    <img src="../Images/bat.jpeg" alt="Batmobile" class="car-image">
                    <p class="car-name">BOOK</p>
                </a>
                <p>Batman</p>
            </div>
